...
cipher:	cipher.o Playfair.o Caesar.o Railfence.o RowTransposition.o Vigenere.o HillCipher.o MainHelperFunctions.o
	g++ cipher.o Playfair.o Caesar.o Railfence.o RowTransposition.o Vigenere.o -o cipher
...
ErrorHandling.cpp.o:	ErrorHandling.cpp ErrorHandling.h 
